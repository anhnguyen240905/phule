  ...
  return (
    <div className="bg-gradient-to-br from-cyan-50 to-yellow-50 rounded-2xl p-6 shadow-lg text-center">
      ...
      <div className="mt-6 flex justify-center gap-4">
        <button onClick={restart} className="px-4 py-2 rounded-lg bg-blue-600 text-white">Thử lại</button>
        <button onClick={()=>window.print()} className="px-4 py-2 rounded-lg border">Tải thiệp / In</button>
      </div>
    </div>
  );
}
